...
$(function() {
  ...
  var COPY_WARNING = "复制<strong>失败</strong>，请手动复制";
  var ENCRYPT_WARNING = "请输入要加密的文字";
  var ENCRYPT_ERROR = "加密<strong>失败</strong>";
  var DECRYPT_WARNING = "请输入要解密的表情符号";
  var DECRYPT_ERROR = "解密<strong>失败</strong>";
